...
export const hbsToHtml = (hbs: string, sampleData: any) => {
  ...
  try {
    ...
    console.log("HBS to HTML Result - ", finalResult)
    console.log("######################################");
    return finalResult;
  } catch (error) {
    console.log("Error in HBS to HTML", error)
    return;
  }
};
...
export const htmlToHbs = (html: string) => {
  try {
    console.log("######################################");
    console.log("[REACT-PACKAGE] - HTML to HBS conversion Started");
    ...
    // --- Restore placeholders back to original void elements ---
    placeholders.forEach((original, i) => {
      finalResult = finalResult.replace(`__VOID_PLACEHOLDER_${i}__`, original);
    });
    
    console.log("[REACT-PACKAGE] - HTML to HBS conversion Completed");
    console.log("HTML to HBS Result - ", finalResult)
    console.log("######################################");
    return finalResult;
  } catch (error) {
    console.log("Error in HTML to HBS", error)
    return;
  }
};
